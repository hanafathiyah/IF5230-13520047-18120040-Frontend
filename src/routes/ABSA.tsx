...
const ABSA = () => {
  ...
  const handleClickGemini = async () => {
    if (sentiment != "") {
      ...
      const prompt = `Do aspect based sentiment analysis based on the sentence: ${sentiment}, extract the tuples in the format '(index) aspect : a1 , opinion : o1 , polarity : p1 (enter) (index) aspect : a2 ...`;
